    ...
    return (
        <div>
            ...
            {data?.waitTimes.map((hospital) => (
                <div
                    key={hospital.slug || hospital.name[lang]}
                    style={{
                ...
                >
                    ...
                    <p>
                        <strong>Urgent (Median):</strong>{" "}
                        {renderWaitTime(hospital.waitTimes.urgentP50Minutes)}
                    </p>
                    <p>
                        <strong>Semi-Urgent/Non-Urgent (Median):</strong>{" "}
                        {renderWaitTime(
                    ...
                    <p>
                        <strong>
                            Semi-Urgent/Non-Urgent (95th Percentile):
                        </strong>{" "}
                        {renderWaitTime(
