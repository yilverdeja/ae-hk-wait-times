...
export const gopcMongKokLiPoChun: PhysicalAlternative = {
    "slug": "gopc-mong-kok-li-po-chun",
    "category": "non24hour",
    "name": {
        "en": "Mong Kok Li Po Chun FMC (HA)",
        "zh": "旺角李寶椿家庭醫學診所",
        "cn": "旺角李宝椿家庭医学诊所"
    },
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0112) or HA Go app",
                    "zh": "醫管局電話預約（3157 0112）或HA Go",
                    "cn": "医管局电话预约（3157 0112）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
