...
export const gopcChaiWan: PhysicalAlternative = {
    ...
    "location": {
        "district": "Chai Wan",
        "address": {
            "en": "G/F, 1 Hong Man Street, Chai Wan, Hong Kong",
            "zh": "香港柴灣康民街1號地下",
            "cn": "香港柴灣康民街1號地下"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of Hong Kong East Cluster. Near Chai Wan MTR Station.",
        "zh": "Part of Hong Kong East Cluster. Near Chai Wan MTR Station.",
        "cn": "Part of Hong Kong East Cluster. Near Chai Wan MTR Station."
    },
    "sourceUrls": [
        {
