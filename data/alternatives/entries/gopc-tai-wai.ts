...
export const gopcTaiWai: PhysicalAlternative = {
    "slug": "gopc-tai-wai",
    "category": "non24hour",
    "name": {
        "en": "Shatin (Tai Wai) GOPC (HA)",
        "zh": "沙田（大圍）普通科門診",
        "cn": "沙田（大圍）普通科門診"
    },
    ...
    "location": {
        "district": "Tai Wai",
        "address": {
            "en": "G/F, Tai Wai Government Offices, 2 Mei Tin Road, Tai Wai, Sha Tin, New Territories",
            "zh": "新界沙田大圍美田路2號大圍政府合署地下",
            "cn": "新界沙田大圍美田路2號大圍政府合署地下"
        },
        "coordinates": {
            "latitude": 22.374,
            "longitude": 114.173
    ...
    "additionalInfo": {
        "en": "Part of New Territories East Cluster. Sha Tin District. Near Tai Wai MTR Station.",
        "zh": "Part of New Territories East Cluster. Sha Tin District. Near Tai Wai MTR Station.",
        "cn": "Part of New Territories East Cluster. Sha Tin District. Near Tai Wai MTR Station."
    },
    "sourceUrls": [
        {
