...
export const gopcSaiYingPunJockeyClub: PhysicalAlternative = {
    "slug": "gopc-sai-ying-pun-jockey-club",
    "category": "non24hour",
    "name": {
        "en": "Sai Ying Pun Jockey Club FMC (HA)",
        "zh": "西營盤賽馬會家庭醫學診所",
        "cn": "西营盘赛马会家庭医学诊所"
    },
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3543 5000) or HA Go app",
                    "zh": "醫管局電話預約（3543 5000）或HA Go",
                    "cn": "医管局电话预约（3543 5000）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
