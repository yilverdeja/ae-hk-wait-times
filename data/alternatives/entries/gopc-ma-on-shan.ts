...
export const gopcMaOnShan: PhysicalAlternative = {
    ...
    "location": {
        "district": "Ma On Shan",
        "address": {
            "en": "G/F, 609 Sai Sha Road, Ma On Shan",
            "zh": "馬鞍山西沙路609號地下",
            "cn": "马鞍山西沙路609号地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0982) or HA Go app",
                    "zh": "醫管局電話預約（3157 0982）或HA Go",
                    "cn": "医管局电话预约（3157 0982）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
