...
export const gopcStanley: PhysicalAlternative = {
    "slug": "gopc-stanley",
    "category": "non24hour",
    "name": {
        "en": "Stanley GOPC (HA)",
    ...
    "location": {
        "district": "Stanley",
        "address": {
            "en": "G/F, 14 Wong Ma Kok Road, Stanley, Hong Kong",
            "zh": "香港赤柱黃麻角道14號地下",
            "cn": "香港赤柱黃麻角道14號地下"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of Hong Kong West Cluster (Southern District). Serves Stanley / South Side area.",
        "zh": "Part of Hong Kong West Cluster (Southern District). Serves Stanley / South Side area.",
        "cn": "Part of Hong Kong West Cluster (Southern District). Serves Stanley / South Side area."
    },
    "sourceUrls": [
        {
