...
export const gopcLekYuen: PhysicalAlternative = {
    "slug": "gopc-lek-yuen",
    "category": "non24hour",
    "name": {
        "en": "Lek Yuen GOPC (HA)",
    ...
    "location": {
        "district": "Sha Tin",
        "address": {
            "en": "Lek Yuen Health Centre, Lek Yuen Estate, Sha Tin, New Territories",
            "zh": "新界沙田瀝源邨瀝源健康院",
            "cn": "新界沙田瀝源邨瀝源健康院"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of New Territories East Cluster. Sha Tin District.",
        "zh": "Part of New Territories East Cluster. Sha Tin District.",
        "cn": "Part of New Territories East Cluster. Sha Tin District."
    },
    "sourceUrls": [
        {
