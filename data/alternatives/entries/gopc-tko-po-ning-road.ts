...
export const gopcTkoPoNingRoad: PhysicalAlternative = {
    ...
    "category": "non24hour",
    "name": {
        "en": "Tseung Kwan O (Po Ning Road) FMC (HA)",
        "zh": "將軍澳（寶寧路）家庭醫學診所",
        "cn": "将军澳（宝宁路）家庭医学诊所"
    },
    ...
    "location": {
        ...
        "address": {
            "en": "G/F, 28 Po Ning Road, Tseung Kwan O",
            "zh": "將軍澳寶寧路28號地下",
            "cn": "将军澳宝宁路28号地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0660) or HA Go app",
                    "zh": "醫管局電話預約（3157 0660）或HA Go",
                    "cn": "医管局电话预约（3157 0660）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
