...
export const gopcShaTauKok: PhysicalAlternative = {
    "slug": "gopc-sha-tau-kok",
    "category": "non24hour",
    "name": {
        "en": "Sha Tau Kok FMC (HA)",
        "zh": "沙頭角家庭醫學診所",
        "cn": "沙头角家庭医学诊所"
    },
    ...
    "location": {
        "district": "Sha Tau Kok",
        "address": {
            "en": "G/F, 58 Sha Tau Kok Road (Shek Chung Au), Sha Tau Kok",
            "zh": "沙頭角公路（石涌凹段）58號地下",
            "cn": "沙头角公路（石涌凹段）58号地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3165 1070) or HA Go app",
                    "zh": "醫管局電話預約（3165 1070）或HA Go",
                    "cn": "医管局电话预约（3165 1070）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
