...
export const gopcTinShuiWai: PhysicalAlternative = {
    "slug": "gopc-tin-shui-wai",
    "category": "non24hour",
    "name": {
        "en": "Tin Shui Wai (Tin Yip Road) FMC (HA)",
        "zh": "天水圍（天業路）家庭醫學綜合中心",
        "cn": "天水围（天业路）家庭医学综合中心"
    },
    "providerType": "Public Clinic",
    "description": {
        "en": "Hospital Authority Family Medicine Clinic (New Territories West Cluster). Appointment required.",
        "zh": "醫管局家庭醫學診所（新界西醫院聯網）。須預約。",
        "cn": "医管局家庭医学诊所（新界西医院联网）。须预约。"
    },
    "location": {
        "district": "Tin Shui Wai (Opposite Hong Kong Wetland Park and Vianni Cove of Tin Kwai Road)",
        "address": {
            "en": "3, Tin Yip Road, Tin Shui Wai (Opposite Hong Kong Wetland Park and Vianni Cove of Tin Kwai Road)",
            "zh": "天水圍天業路3號(香港濕地公園及天葵路慧景軒對面)",
            "cn": "天水围天业路3号(香港湿地公园及天葵路慧景轩对面)"
        },
        "coordinates": {
            "latitude": 22.465478,
            "longitude": 114.00583
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (2469 9222) or HA Go app",
                    "zh": "醫管局電話預約（2469 9222）或HA Go",
                    "cn": "医管局电话预约（2469 9222）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
