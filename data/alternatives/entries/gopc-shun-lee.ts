...
export const gopcShunLee: PhysicalAlternative = {
    "slug": "gopc-shun-lee",
    "category": "non24hour",
    "name": {
        "en": "Shun Lee FMC (HA)",
    ...
    "location": {
        "district": "Kwun Tong",
        "address": {
            "en": "G/F, Lee Foo House, Shun Lee Estate, Kwun Tong",
            "zh": "觀塘順利邨利富樓地下",
            "cn": "观塘顺利邨利富楼地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0682) or HA Go app",
                    "zh": "醫管局電話預約（3157 0682）或HA Go",
                    "cn": "医管局电话预约（3157 0682）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
