...
export const gopcTaiPoWongSiuChing: PhysicalAlternative = {
    "slug": "gopc-tai-po-wong-siu-ching",
    "category": "non24hour",
    "name": {
        "en": "Tai Po Wong Siu Ching FMC (HA)",
        "zh": "大埔王少清家庭醫學診所",
        "cn": "大埔王少清家庭医学诊所"
    },
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0926) or HA Go app",
                    "zh": "醫管局電話預約（3157 0926）或HA Go",
                    "cn": "医管局电话预约（3157 0926）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
