...
export const gopcYuenLongJockeyClub: PhysicalAlternative = {
    "slug": "gopc-yuen-long-jockey-club",
    "category": "non24hour",
    "name": {
        "en": "Yuen Long Jockey Club FMC (HA)",
        "zh": "元朗賽馬會家庭醫學診所",
        "cn": "元朗赛马会家庭医学诊所"
    },
    ...
    "location": {
        "district": "Yuen Long",
        "address": {
            "en": "269 Castle Peak Road (Yuen Long), Yuen Long",
            "zh": "元朗青山公路（元朗段）269號",
            "cn": "元朗青山公路（元朗段）269号"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3543 5007) or HA Go app",
                    "zh": "醫管局電話預約（3543 5007）或HA Go",
                    "cn": "医管局电话预约（3543 5007）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
