...
export const gopcPengChau: PhysicalAlternative = {
    "slug": "gopc-peng-chau",
    "category": "non24hour",
    "name": {
        "en": "Peng Chau FMC (HA)",
    ...
    "location": {
        "district": "Peng Chau",
        "address": {
            "en": "G/F, 1A Shing Ka Road, Peng Chau",
            "zh": "坪洲聖家路1號A地下",
            "cn": "坪洲圣家路1号A地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3165 1058) or HA Go app",
                    "zh": "醫管局電話預約（3165 1058）或HA Go",
                    "cn": "医管局电话预约（3165 1058）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
