...
export const gopcFanling: PhysicalAlternative = {
    "slug": "gopc-fanling",
    "category": "non24hour",
    "name": {
        "en": "Fanling FMC (HA)",
    ...
    "location": {
        "district": "Fanling",
        "address": {
            "en": "1/F, Fanling Health Centre, 2 Pik Fung Road, Fanling",
            "zh": "粉嶺璧峰路2號粉嶺健康中心1樓",
            "cn": "粉岭璧峰路2号粉岭健康中心1楼"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0937) or HA Go app",
                    "zh": "醫管局電話預約（3157 0937）或HA Go",
                    "cn": "医管局电话预约（3157 0937）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
