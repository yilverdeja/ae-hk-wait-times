...
export const gopcWanTsuiEstate: PhysicalAlternative = {
    "slug": "gopc-wan-tsui-estate",
    "category": "non24hour",
    "name": {
        "en": "Wan Tsui Estate GOPC (HA)",
        "zh": "環翠邨普通科門診",
        "cn": "環翠邨普通科門診"
    },
    ...
    "location": {
        "district": "Chai Wan",
        "address": {
            "en": "G/F, Block 12, Wan Tsui Estate, Chai Wan, Hong Kong",
            "zh": "香港柴灣環翠邨第12座地下",
            "cn": "香港柴灣環翠邨第12座地下"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of Hong Kong East Cluster.",
        "zh": "Part of Hong Kong East Cluster.",
        "cn": "Part of Hong Kong East Cluster."
    },
    "sourceUrls": [
        {
