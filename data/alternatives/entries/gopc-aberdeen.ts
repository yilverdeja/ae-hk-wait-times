...
export const gopcAberdeen: PhysicalAlternative = {
    "slug": "gopc-aberdeen",
    "category": "non24hour",
    "name": {
        "en": "Aberdeen Jockey Club GOPC (HA)",
        "zh": "香港仔賽馬會普通科門診",
        "cn": "香港仔賽馬會普通科門診"
    },
    ...
    "location": {
        "district": "Aberdeen",
        "address": {
            "en": "G/F, 10 Aberdeen Reservoir Road, Aberdeen, Hong Kong",
            "zh": "香港香港仔水塘道10號地下",
            "cn": "香港香港仔水塘道10號地下"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of Hong Kong West Cluster (Southern District).",
        "zh": "Part of Hong Kong West Cluster (Southern District).",
        "cn": "Part of Hong Kong West Cluster (Southern District)."
    },
    "sourceUrls": [
        {
