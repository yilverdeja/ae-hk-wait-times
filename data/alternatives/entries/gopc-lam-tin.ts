...
export const gopcLamTin: PhysicalAlternative = {
    "slug": "gopc-lam-tin",
    "category": "non24hour",
    "name": {
        "en": "Lam Tin FMC (HA)",
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0679) or HA Go app",
                    "zh": "醫管局電話預約（3157 0679）或HA Go",
                    "cn": "医管局电话预约（3157 0679）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
