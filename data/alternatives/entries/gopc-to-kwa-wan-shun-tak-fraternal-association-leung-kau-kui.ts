...
export const gopcToKwaWanShunTakFraternalAssociationLeungKauKui: PhysicalAlternative = {
    "slug": "gopc-to-kwa-wan-shun-tak-fraternal-association-leung-kau-kui",
    "category": "non24hour",
    "name": {
        "en": "To Kwa Wan Shun Tak Fraternal Association Leung Kau Kui FMC (HA)",
        "zh": "土瓜灣順德聯誼會梁銶琚家庭醫學診所",
        "cn": "土瓜湾顺德联谊会梁銶琚家庭医学诊所"
    },
    "providerType": "Public Clinic",
    "description": {
        "en": "Hospital Authority Family Medicine Clinic (Kowloon Central Cluster). Appointment required.",
        "zh": "醫管局家庭醫學診所（九龍中醫院聯網）。須預約。",
        "cn": "医管局家庭医学诊所（九龙中医院联网）。须预约。"
    },
    "location": {
        "district": "Kowloon City",
        "address": {
            "en": "2/F, Tokwawan Market & Government Offices Building, 165 Ma Tau Wai Road, Kowloon City",
            "zh": "九龍城馬頭圍道165號土瓜灣市政大廈暨政府合署2樓",
            "cn": "九龙城马头围道165号土瓜湾市政大厦暨政府合署2楼"
        },
        "coordinates": {
            "latitude": 22.317142,
            "longitude": 114.18799
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0850) or HA Go app",
                    "zh": "醫管局電話預約（3157 0850）或HA Go",
                    "cn": "医管局电话预约（3157 0850）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
