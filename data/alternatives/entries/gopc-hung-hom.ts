...
export const gopcHungHom: PhysicalAlternative = {
    "slug": "gopc-hung-hom",
    "category": "non24hour",
    "name": {
        "en": "Hung Hom FMC (HA)",
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0816) or HA Go app",
                    "zh": "醫管局電話預約（3157 0816）或HA Go",
                    "cn": "医管局电话预约（3157 0816）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
