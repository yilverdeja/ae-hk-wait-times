...
export const gopcNamShan: PhysicalAlternative = {
    "slug": "gopc-nam-shan",
    "category": "non24hour",
    "name": {
        "en": "Nam Shan FMC (HA)",
    ...
    "location": {
        ...
        "address": {
            "en": "G/F, Nam Yiu House, Nam Shan Estate, Sham Shui Po",
            "zh": "深水埗南山邨南堯樓地下",
            "cn": "深水埗南山邨南尧楼地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0120) or HA Go app",
                    "zh": "醫管局電話預約（3157 0120）或HA Go",
                    "cn": "医管局电话预约（3157 0120）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
