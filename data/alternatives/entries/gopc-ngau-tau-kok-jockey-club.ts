...
export const gopcNgauTauKokJockeyClub: PhysicalAlternative = {
    "slug": "gopc-ngau-tau-kok-jockey-club",
    "category": "non24hour",
    "name": {
        "en": "Ngau Tau Kok Jockey Club FMC (HA)",
        "zh": "牛頭角賽馬會家庭醫學診所",
        "cn": "牛头角赛马会家庭医学诊所"
    },
    "providerType": "Public Clinic",
    "description": {
        "en": "Hospital Authority Family Medicine Clinic (Kowloon East Cluster). Appointment required.",
        "zh": "醫管局家庭醫學診所（九龍東醫院聯網）。須預約。",
        "cn": "医管局家庭医学诊所（九龙东医院联网）。须预约。"
    },
    "location": {
        "district": "Ngau Tau Kok",
        "address": {
            "en": "G/F, 60 Ting On Street, Ngau Tau Kok",
            "zh": "牛頭角定安街60號地下",
            "cn": "牛头角定安街60号地下"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0680) or HA Go app",
                    "zh": "醫管局電話預約（3157 0680）或HA Go",
                    "cn": "医管局电话预约（3157 0680）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
