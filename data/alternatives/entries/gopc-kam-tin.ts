...
export const gopcKamTin: PhysicalAlternative = {
    "slug": "gopc-kam-tin",
    "category": "non24hour",
    "name": {
        "en": "Kam Tin FMC (HA)",
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3543 5008) or HA Go app",
                    "zh": "醫管局電話預約（3543 5008）或HA Go",
                    "cn": "医管局电话预约（3543 5008）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
