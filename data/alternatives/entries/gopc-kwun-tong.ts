...
export const gopcKwunTong: PhysicalAlternative = {
    "slug": "gopc-kwun-tong",
    "category": "non24hour",
    "name": {
        "en": "Kwun Tong FMC (HA)",
    ...
    "location": {
        "district": "Kwun Tong",
        "address": {
            "en": "UG, 60 Hip Wo Street, Kwun Tong",
            "zh": "觀塘協和街60號地下高層",
            "cn": "观塘协和街60号地下高层"
        },
        "coordinates": {
    ...
    "channels": [
        {
            ...
            "booking": {
                ...
                "walkIn": false,
                "methods": {
                    "en": "HA telephone booking (3157 0687) or HA Go app",
                    "zh": "醫管局電話預約（3157 0687）或HA Go",
                    "cn": "医管局电话预约（3157 0687）或HA Go"
                }
            },
            "pricing": {
                "tiers": [
