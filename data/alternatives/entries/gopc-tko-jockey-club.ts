...
export const gopcTkoJockeyClub: PhysicalAlternative = {
    "slug": "gopc-tko-jockey-club",
    "category": "non24hour",
    "name": {
        "en": "Tseung Kwan O Jockey Club GOPC (HA)",
        "zh": "將軍澳賽馬會普通科門診",
        "cn": "將軍澳賽馬會普通科門診"
    },
    ...
    "location": {
        ...
        "address": {
            "en": "Tseung Kwan O Jockey Club General Outpatient Clinic, Tseung Kwan O, New Territories",
            "zh": "新界將軍澳賽馬會普通科門診",
            "cn": "新界將軍澳賽馬會普通科門診"
        },
        "coordinates": {
    ...
    "additionalInfo": {
        "en": "Part of Kowloon East Cluster (Sai Kung District). Facility enhancement completed in 2020.",
        "zh": "Part of Kowloon East Cluster (Sai Kung District). Facility enhancement completed in 2020.",
        "cn": "Part of Kowloon East Cluster (Sai Kung District). Facility enhancement completed in 2020."
    },
    "sourceUrls": [
        {
